...
const Login = () => {
    ...
    return (
        <div className="min-h-screen bg-[#050B0F] text-white">
            <Navbar />
                ...
                >
                    ...
                    <div className="my-4">
                        ...
                        <Input
                            ...
                            onChange={changeEventHandler}
                            placeholder="patel@gmail.com"
                            className="mt-1 bg-transparent text-white border-white/20 focus:border-emerald-400"
                        />
                    </div>
                    ...
                    {/* Role */}
                    <RadioGroup className="flex items-center gap-6 my-6">
                        <div className="flex items-center space-x-2">
                            <Input
                                type="radio"
                                name="role"
                    ...
                    {/* Button */}
                    {loading ? (
                        <Button className="w-full my-4 bg-emerald-400 text-black">
                        ...
                        <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
                            <Button
                                ...
                                className="
                                    ...
                                    shadow-[0_0_25px_rgba(0,255,170,0.6)]
                                "
                            >
                                Login
                            </Button>
